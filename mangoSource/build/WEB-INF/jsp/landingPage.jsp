      ...
      <div dojoType="SplitContainer" orientation="horizontal" sizerWidth="3" activeSizing="true" class="borderDiv"
        ...
        <div dojoType="ContentPane" sizeMin="20" sizeShare="20" style="overflow:auto;padding:2px;">
            ...
            <span class="smallTitle">Information about Mango</span>
                      <p>Mango is an open-source M2M (Machine to Machine) platform that provides a comprehensive solution for managing and monitoring devices and sensors. It offers a wide range of features including data collection, analysis, and visualization.</p>
                      <p>Mango supports various types of sensors, including temperature, humidity, and motion sensors, among others. These sensors can be used to monitor environmental conditions, detect movement, and more. The platform's modular architecture allows for easy integration with different types of devices and sensors, making it highly versatile.</p>
                      <p>With Mango, you can create custom dashboards to monitor your devices and sensors in real-time, set up alerts for specific conditions, and even share data with other users. You can modify watch lists <a href="/test/watch_list.shtm">here</a>. If you wish to edit the system settings you can change them <a href="/test/system_settings.shtm">here</a>.
        </div>
